...
namespace ORUtils
{
    ...
    //////////////////////////////////////////////////////////////////////////
    template <class T> class Matrix4:public Matrix4_<T>
    {
    public:
        ...
        _CPU_AND_GPU_CODE_ inline void getValues(T *mp){memcpy(mp,this->m,sizeof(T)*16);}
        _CPU_AND_GPU_CODE_ inline const T* getValues(){return this->m;}
        _CPU_AND_GPU_CODE_ inline Vector3<T> getScale(){return Vector3<T>(this->m00,this->m11,this->m22);}
        // Element access
        // Element access
    ...
    public:
        ...
        _CPU_AND_GPU_CODE_ inline void getValues(T *mp) const	{ memcpy(mp, this->m, sizeof(T) * s*s); }
        _CPU_AND_GPU_CODE_ inline const T *getValues() const { return this->m; }
