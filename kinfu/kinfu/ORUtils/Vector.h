...
//////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        //  Constructors
        ////////////////////////////////////////////////////////
        _CPU_AND_GPU_CODE_ Vector2(){}
        _CPU_AND_GPU_CODE_ Vector2(const T &t){this->x=t; this->y=t;}
        ...
        _CPU_AND_GPU_CODE_ const T *getValues() const{
            return this->v;
        }

        _CPU_AND_GPU_CODE_ Vector2<T> &setValues(const T *rhs){
            this->x=rhs[0];this->y=rhs[1];return *this;
        }
        ...
        // type-cast operators
        _CPU_AND_GPU_CODE_ T operator *(){return this->v;}
        _CPU_AND_GPU_CODE_ const T operator *() const {return this->v;}
